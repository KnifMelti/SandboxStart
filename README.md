...
5. For `.intunewin` files: auto-downloads `IntuneWinAppUtilDecoder.exe` so it can be extracted correctly ([Oliver Kieselbach](https://oliverkieselbach.com/2022/03/30/ime-debugging-and-intune-win32-app-decoding-part-2/))
6. Click OK

...
- Provides (if needed/chosen in **WSB**):
  - `IntuneWinAppUtilDecoder.exe`
    - 1.0.0.4: with added parameter `/out` that redirects the file output and preserves `Detection.xml`: [KnifMelti](https://github.com/KnifMelti/SandboxStart/raw/master/Source/assets/IntuneWinAppUtilDecoder.exe) (digitally signed)
    - 1.0.0.3: [Oliver Kieselbach](https://oliverkieselbach.com/2019/01/03/how-to-decode-intune-win32-app-packages/) (original project)
